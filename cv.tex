...
\begin{aside2}
   ...
   \devitem{\href{https://github.ugent.be/biomath/pySTAN}{PySTAN}}{Model STructure ANalyst, library with set of functionalities to evaluate model performance (in revision now, \textit{Ugent only})}
