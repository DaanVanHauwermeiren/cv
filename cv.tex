...
%Currently mainly active on \href{https://github.ugent.be/stvhoey}{github.ugent.be}, but the developments made within the framework of the phd will be licensed as open source on my \href{https://github.com/stvhoey}{personal Github account}.
...
\begin{refsection}
  \nocite{*}
  \printbibliography[sorting=chronological, type=inproceedings, title={presentations}, keyword={oral}, heading=subbibliography]
\end{refsection}
