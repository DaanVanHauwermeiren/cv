...
\documentclass[]{friggeri-cv}  %[print]
...
\begin{aside2}
   ...
   \subsection{python}
   \devitem{\href{https://stijnvanhoey.github.io/hydropy/}{hydropy}}{Tiny package to improve and simplify working with hydrological time series}
   \devitem{\href{https://github.ugent.be/biomath/pySTAN}{PySTAN}}{Model STructure ANalyst, library with set of functionalities to evaluate model performance (currently in revision, Ugent only)}
   \devitem{\href{https://github.ugent.be/biomath/pyFUSE}{PyFUSE}}{Flexible model development environment for lumped hydrological models (Ugent only)}   
   \subsection{webdev}
