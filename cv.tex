...
\hyphenation{in-fra-struc-tuur-wer-ken qua-li-ty seun-tjens	x}

%\usepackage[utf8]{inputenc}

\begin{document}
\header{Stijn Van Hoey}{}% Stijn Van Hoey Curriculum vitae
       {Bioscience Engineer with IT affinity}%Bioscience Engineer with IT affinity
...
\begin{aside}
  \section{about}
    ...
    Belgium
    ~
    \includegraphics[height=8pt]{mail.pdf}   \href{mailto:stijnvanhoey@gmail.com}{stijnvanhoey@gmail.com} 
...
\begin{entrylist}
  \entry
    ...
    {\emph{Development and application of a framework for model structure evaluation in environmental modelling}\\ %zenodo.168478.svg
		\small{supervised by Prof dr ir Piet Seuntjens and Prof dr ir Ingmar Nopens}\\
		        \href{https://doi.org/10.5281/zenodo.168478}{\includegraphics[height=8pt]{zenodo.pdf}}}
...
\begin{aside2}
   ...
   \devitem{\href{http://stijnvanhoey.github.io/pyfuse/}{pyfuse}}{Flexible model environment for lumped hydrological models}     
   \devitem{\href{http://stijnvanhoey.github.io/pystran/}{pystran}}{Model STRucture ANalyst, library with set of functionalities to evaluate model characteristics}
    \devitem{\href{https://github.com/gbellandi/bubble_size_analysis}{bubblekicker}}{Package for automated air bubble detection from high speed camera images}
   \subsection{webdev}
...
\phantom{publications} % solve heading margins
\vspace{-26pt}
